...
namespace ConsultorioWeb.Controllers
{
    ...
    public class PersonalesInternosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdPersonal,Nombre,Apellido,NumeroDocumento,FechaNacimiento,Edad,Sexo,EstadoCivil,TelCel,Email,Activo,Direccion,IdCiudad,IdProvincia,IdPais,IdUsuario,IdMedico")] PersonalInterno personalInterno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdPersonal,Nombre,Apellido,NumeroDocumento,FechaNacimiento,Edad,Sexo,EstadoCivil,TelCel,Email,Activo,Direccion,IdCiudad,IdProvincia,IdPais,IdUsuario,IdMedico")] PersonalInterno personalInterno)
        {
            if (ModelState.IsValid)
            {

...
namespace ConsultorioWeb.Controllers
{
    ...
    public class EspecialidadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EspecialidadId,Nombre,PrecioPorDefecto")] Especialidad especialidad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EspecialidadId,Nombre,PrecioPorDefecto")] Especialidad especialidad)
        {
            if (ModelState.IsValid)
            {
